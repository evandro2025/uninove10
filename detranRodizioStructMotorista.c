...
int main(void)
{
  ...
  printf("\n\n --------- Lendo os dados da struct Carro Motorista---------\n\n");
  printf("Nome ...........: %s", aluno.nome);
  printf("Informe marca e modelo ...........: %s", aluno.nome); 	
  printf("Disciplina .....: %s", aluno.disciplina);
  printf("Informe sua placa .....: %s", aluno.disciplina);
  printf("Placa final 9\n");
  printf("Hoje eh segunda feira.\n");
  printf("Voce NAO stah no Rodizio\n");
